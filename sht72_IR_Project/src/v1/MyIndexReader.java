...
public class MyIndexReader {
	...
	public MyIndexReader() throws IOException {
		directory = FSDirectory.open(Paths.get(v1.Path.IndexDir));  
	...
	/*public int getDocid( String docno ) throws IOException {
		...
		TermQuery query = new TermQuery(new Term("DOCNO", docno));
	 ...
	 * @throws IOException 
	 */
	public String getJobname( int docid ) throws IOException {
		// you should implement this method.
		Document doc = ireader.document(docid);
		return (doc==null)?null:doc.get("JOBNAME");
	}
	...
	/*public String getDESC(int docid) throws IOException {
		// you should implement this method.
		Document doc = ireader.document(docid);
		return (doc==null)?null:doc.get("DESC");
	}*/
	...
	// this get postinglist from content field.
	public int[][] getPostingList( String token ) throws IOException {
		...
		if(df==0)
			return null;
		TermQuery query = new TermQuery(tm);
